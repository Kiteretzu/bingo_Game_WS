import { GAME_INIT, MessageType, SEND_CHECKBOXES, SEND_GAMEBOARD } from '@/assets/constants'; // Removed unused `SEND_ID`
...
function Landing() {
    ...
    const { sendData } = useGame(); // Custom hook to handle game actions
    ...
    // Function to handle matchmaking initiation
