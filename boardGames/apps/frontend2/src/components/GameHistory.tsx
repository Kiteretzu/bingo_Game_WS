...
const gameResults: GameResult[] = [
  { id: 1, outcome: 'Win', ranked: true, duration: '25:13', mmrChange: 25, date: '2025-01-23' },
  { id: 2, outcome: 'Loss', ranked: true, duration: '31:45', mmrChange: -20, date: '2025-01-22' },
  { id: 3, outcome: 'Win', ranked: false, duration: '18:22', mmrChange: 0, date: '2025-01-21' },
  { id: 4, outcome: 'Win', ranked: true, duration: '28:57', mmrChange: 22, date: '2025-01-20' },
  { id: 5, outcome: 'Loss', ranked: true, duration: '35:10', mmrChange: -18, date: '2025-01-19' },
]
...
const GameCard = ({ game }: { game: GameResult }) => (
  ...
  >
    ...
    {/* Date */}
    <div className="text-gray-400 text-sm xl:font-semibold xl:text-lg">{new Date(game.date).toLocaleDateString()}</div>
    {/* Duration */}
    <motion.div className="flex items-center" >
